...
01. [Šta je goroutine?](#pitanje-01--šta-je-goroutine)
02. [Po čemu se goroutine razlikuje od OS thread-a?](#pitanje-02--po-čemu-se-goroutine-razlikuje-od-os-thread-a)
03. [Kako se pokreće goroutine?](#pitanje-03--kako-se-pokreće-goroutine)
04. [Da li `go` garantuje da će goroutine završiti pre `main()` funkcije?](#pitanje-04--da-li-go-garantuje-da-će-goroutine-završiti-pre-main-funkcije)
05. [Šta je channel i čemu služi?](#pitanje-05--šta-je-channel-i-čemu-služi)
06. [Šta je goroutine i po čemu se razlikuje od klasičnog OS thread-a?](#pitanje-06--šta-je-goroutine-i-po-čemu-se-razlikuje-od-klasičnog-os-thread-a)
07. [Šta se dešava kada napišemo `go process()`?](#pitanje-07--šta-se-dešava-kada-napišemo-go-process)
08. [Da li je izvršavanje goroutines determinističko?](#pitanje-08--da-li-je-izvršavanje-goroutines-determinističko)
09. [Šta je channel u Go-u?](#pitanje-09--šta-je-channel-u-go-u)
